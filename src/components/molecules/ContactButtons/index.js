...
const DEFAULT_BUSINESS_REPORT = {name: "", email: "", message: "", type:"business"};
...
const ContactUsButtons = (props) => {
    ...
    const [businessContactForm, setBusinessContactForm] = React.useState(DEFAULT_BUSINESS_REPORT);
    const [bugReportContactForm, setBugReportContactForm] = React.useState(DEFAULT_BUG_REPORT);
      ...
      return (
        <>
          ...
          <Box flexDirection="row">
            <FormControl className={classes.root} noValidate autoComplete="off" xs={12}>
            <div>
              <TextField className={classes.textboxStyling}
                my={2}
                fullWidth
                type="text"
                id="name"
    ...
    const BugReportContactModalContent = () => {
      return (
        <>
          <h3>Thanks immencely with your help with finding bugs in our application! All insite is appreciated insite!</h3>
          <Box flexDirection="row">
          <FormControl className={classes.root} noValidate autoComplete="off" xs={12}>
            <div>
              <TextField className={classes.textboxStyling}
            ...
            <div>
              <Grid container spacing={2}>
                <Grid item>
                  <PSButton text={"Submit Bug"} onClick={submitBugReportContactForm} />
                </Grid>
                <Grid item>
                  <PSButton  ml={2} text={"Cancel"} onClick={handleBugReportDialogClosing} />
                </Grid>
              </Grid>
            </div>
            </FormControl>
  ...
  */
  return (
    <Grid container xs={12} spacing={2}>
        ...
        <Grid item xs={12}>
            <Button className={classes.buttonStyling} onClick={webAppBugContactButtonClick} fullWidth> Web App Blunders </Button>
        </Grid>
        <PSDialog
